...
class TokenApi
{
     ...
     * @return \EvoliaV3\Model\AuthenticationResponse
     */
    public function userLogin($body = null)
    {
     ...
     * @return array of \EvoliaV3\Model\AuthenticationResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function userLoginWithHttpInfo($body = null)
    {
        $returnType = '\EvoliaV3\Model\AuthenticationResponse';
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function userLoginAsync($body = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function userLoginAsyncWithHttpInfo($body = null)
    {
        $returnType = '\EvoliaV3\Model\AuthenticationResponse';
        $request = $this->userLoginRequest($body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function userLoginRequest($body = null)
    {

        $resourcePath = '/api/v3/token';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
