...
class ReferencesApi
{
     ...
     * @return \Swagger\Client\Model\ReferencesResponse
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\ReferencesResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function apiV3ReferencesListGetWithHttpInfo()
    {
        $returnType = '\Swagger\Client\Model\ReferencesResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\ReferencesResponse',
