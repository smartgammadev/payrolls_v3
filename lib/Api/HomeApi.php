...
class HomeApi
{
     ...
     * @return \Swagger\Client\Model\HealthCheck
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\HealthCheck, HTTP status code, HTTP response headers (array of strings)
     */
    public function healthGetWithHttpInfo()
    {
        $returnType = '\Swagger\Client\Model\HealthCheck';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\HealthCheck',
