...
class UserApi
{
     ...
     *
     * @param  \Swagger\Client\Model\UserLoginRequest $body body (optional)
     *
     ...
     *
     * @param  \Swagger\Client\Model\UserLoginRequest $body (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     *
     * @param  \Swagger\Client\Model\UserRegistrationRequest $body body (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\AuthenticationResponse
     ...
     *
     * @param  \Swagger\Client\Model\UserRegistrationRequest $body (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\AuthenticationResponse, HTTP status code, HTTP response headers (array of strings)
     ...
     * @return void
     */
    public function apiV3UserUserNameDelete($user_name, $body = null)
    {
        $this->apiV3UserUserNameDeleteWithHttpInfo($user_name, $body);
    }
     ...
     */
    public function apiV3UserUserNameDeleteWithHttpInfo($user_name, $body = null)
    {
        $returnType = '';
        $request = $this->apiV3UserUserNameDeleteRequest($user_name, $body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiV3UserUserNameDeleteAsync($user_name, $body = null)
    {
        return $this->apiV3UserUserNameDeleteAsyncWithHttpInfo($user_name, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiV3UserUserNameDeleteAsyncWithHttpInfo($user_name, $body = null)
    {
        $returnType = '';
        $request = $this->apiV3UserUserNameDeleteRequest($user_name, $body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function apiV3UserUserNameDeleteRequest($user_name, $body = null)
    {
