...
class SiretApi
{
     ...
     *
     * @param  \Swagger\Client\Model\SiretRequest $body body (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\SiretQueryResult[]
     */
     ...
     * This endpoint is used to search the siret in the DB from the NIC and the Siret
     *
     * @param  \Swagger\Client\Model\SiretRequest $body (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\SiretQueryResult[], HTTP status code, HTTP response headers (array of strings)
     */
    public function apiV3SiretSearchPostWithHttpInfo($body = null)
    {
        $returnType = '\Swagger\Client\Model\SiretQueryResult[]';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\SiretQueryResult[]',
